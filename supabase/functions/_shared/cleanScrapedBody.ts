/**
 * Strip scraper artifacts out of a story body before it reaches a crawler.
 *
 * Deno twin of src/lib/cleanScrapedBody.ts — the SPA and the edge runtime
 * cannot share a module (different resolution), so the logic is duplicated
 * deliberately. Keep the two in sync; tests cover both.
 *
