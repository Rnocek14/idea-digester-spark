...
export const TEMPLATE_CITY_ROUTES: SiteRoute[] = [
  ...
  {
    path: "/businesses",
    title: "Lake Geneva local businesses",
    blurb: "Hours, addresses and what locals use them for.",
    changefreq: "weekly",
    priority: "0.8",
    section: "guides",
  },
  {
    ...
    blurb: "The Geneva Square grocery — meat counter and in-store DMV kiosk.",
    changefreq: "monthly",
    priority: "0.8",
    section: "guides",
  },
  {
    ...
    blurb: "Broad Street liquor store — wine, spirits, kegs, event catering.",
    changefreq: "monthly",
    priority: "0.8",
    section: "guides",
  },
  {
    ...
    blurb: "Self-serve frozen yogurt downtown, plus made-to-order yogurt pies.",
    changefreq: "monthly",
    priority: "0.8",
    section: "guides",
  },
