import { FileText, Radio, Megaphone, LayoutDashboard, Mail, CalendarDays, Building2, BarChart3, Users, Image, Heart, Briefcase, Gift, Database, Activity, Store, BookOpen, TrendingUp, MessageSquare, Siren, Globe, Send } from "lucide-react";
...
const menuItems = [
  ...
  { title: "Post Today", url: "/dashboard/post-today", icon: Send },
  { title: "Sources", url: "/dashboard/sources", icon: Radio },
  { title: "Source Health", url: "/dashboard/source-health", icon: Database },
  { title: "Cities", url: "/dashboard/cities", icon: Globe },
  { title: "Right Now Queue", url: "/dashboard/incidents-queue", icon: Siren },
  ...
  { title: "Coverage", url: "/dashboard/coverage", icon: Database },
  ...
  { title: "Deals", url: "/dashboard/deals", icon: Gift },
