    ...
    >
      ...
      >
        ...
        <g fontFamily="ui-sans-serif, system-ui" fill="hsl(215 28% 28%)">
          <text x="195" y="64" fontSize="3.2" fontWeight="700" textAnchor="end" letterSpacing="0.2">
            LAKE GENEVA
          </text>
          <text x="52" y="22" fontSize="2.8" fontWeight="700" textAnchor="middle" letterSpacing="0.2">
            WILLIAMS BAY
          </text>
          <text x="5" y="62" fontSize="2.8" fontWeight="700" textAnchor="start" letterSpacing="0.2">
            FONTANA
          </text>
