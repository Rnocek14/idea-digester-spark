...
-- ===== 20260915120000_welcome_email_on_subscribe.sql ======================
-- Verbatim from supabase/migrations/20260915120000_welcome_email_on_subscribe.sql.
-- Idempotent: ADD COLUMN IF NOT EXISTS, CREATE OR REPLACE, DROP-before-CREATE.
...
-- Verify: should return one row, welcome_column = true and welcome_trigger = 1
SELECT
  EXISTS (SELECT 1 FROM information_schema.columns
